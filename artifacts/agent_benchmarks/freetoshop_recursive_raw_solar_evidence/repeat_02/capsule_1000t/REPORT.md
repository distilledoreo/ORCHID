...
- Retirement: 202,761 tokens in 937.06s = **216.380 tok/s**; margin versus arrival 157.232 tok/s.
- Solar: 18 calls, 324,092 input tokens, 34,641 output tokens, estimated cost $0.013880.
- Failures/timeouts: none / 0.
- Semantic retention: 143 PASS / 35 FAIL across 178 applicable frozen checks.
- Final checkpoint retention: 16 PASS / 3 FAIL.
- Capsule size: final 2388 estimated tokens; maximum 2889.
- Capsule growth: 2.85x from first to final valid generation.
