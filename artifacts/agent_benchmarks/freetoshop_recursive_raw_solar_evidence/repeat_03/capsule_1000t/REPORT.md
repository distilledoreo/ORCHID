...
- Retirement: 202,761 tokens in 732.24s = **276.906 tok/s**; margin versus arrival 217.758 tok/s.
- Solar: 18 calls, 311,674 input tokens, 21,790 output tokens, estimated cost $0.011965.
- Failures/timeouts: none / 0.
- Semantic retention: 117 PASS / 61 FAIL across 178 applicable frozen checks.
- Final checkpoint retention: 18 PASS / 1 FAIL.
- Capsule size: final 1942 estimated tokens; maximum 1971.
- Capsule growth: 12.29x from first to final valid generation.
