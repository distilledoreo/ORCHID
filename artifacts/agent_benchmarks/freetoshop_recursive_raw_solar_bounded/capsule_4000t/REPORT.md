...
- Recursive raw→Solar status: **FAILED**; 12/18 generations completed.
- Retirement: 139,101 tokens in 954.80s = **145.685 tok/s**; margin versus arrival 86.537 tok/s.
- Solar: 13 calls, 228,112 input tokens, 39,025 output tokens, estimated cost $0.011526.
- Failures/timeouts: TimeoutError / 1.
- Semantic retention: 90 PASS / 12 FAIL across 102 applicable frozen checks.
- Final checkpoint retention: 9 PASS / 1 FAIL.
- Capsule size: final 6993 estimated tokens; maximum 6993.
- Capsule growth: 4.27x from first to final valid generation.
