...
- Retirement: 202,761 tokens in 651.98s = **310.995 tok/s**; margin versus arrival 251.847 tok/s.
- Solar: 18 calls, 315,396 input tokens, 25,470 output tokens, estimated cost $0.012518.
- Failures/timeouts: none / 0.
- Semantic retention: 160 PASS / 18 FAIL across 178 applicable frozen checks.
- Final checkpoint retention: 18 PASS / 1 FAIL.
- Capsule size: final 1985 estimated tokens; maximum 1985.
- Capsule growth: 4.77x from first to final valid generation.
